...
func (h Handler) CreateUser(c *gin.Context) {
	...
	if err := check.ValidatePassword(User.Password); err != nil {
		handleResponse(c, h.Log, "error while validating  password: "+User.Password, http.StatusBadRequest, err.Error())
		return
	}
	if err := check.ValidateEmail(User.Mail); err != nil {
		handleResponse(c, h.Log, "error while validating  password: "+User.Mail, http.StatusBadRequest, err.Error())
		return
	}

	HashPassword, err := password.HashPassword(User.Password)
	if err != nil {
		handleResponse(c, h.Log, "password hashing error", http.StatusUnauthorized, err)
	}
...
func (h Handler) UpdateUser(c *gin.Context) {
	...
	if err := check.ValidateEmail(User.Mail); err != nil {
		handleResponse(c, h.Log, "error while validating User Mail "+User.Mail, http.StatusBadRequest, err.Error())
		return
	}
	...
	if err := check.ValidatePhone(User.Phone); err != nil {
		handleResponse(c, h.Log, "error while validating User Phone:"+User.Phone, http.StatusBadRequest, err.Error())
		return
	}
	User.Id = c.Param("id")
	...
	if err != nil {
		handleResponse(c, h.Log, "error while validating Userid: "+User.Id, http.StatusBadRequest, err.Error())
		return
	}
...
func (h Handler) GetAllUsers(c *gin.Context) {
	...
	if err != nil {
		handleResponse(c, h.Log, "error while getting Users", http.StatusBadRequest, err.Error())
...
func (h Handler) DeleteUser(c *gin.Context) {
	...
	if err != nil {
		handleResponse(c, h.Log, "error while validating uuid", http.StatusBadRequest, err.Error())
		return
	}
...
func (h Handler) UpdateStatus(c *gin.Context) {
	...
	handleResponse(c, h.Log, "Updated status successfully", http.StatusOK, id)
}
